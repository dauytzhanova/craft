        ...
        return (
            <div className="new-arrivals">
                <div className="arrivals-books-list">
                    <h5 className="new-arrivals-title">Category:<span> {this.props.location.state.category}</span> </h5>
                    ...
                    <CategoriesList bookElements ={db.books} category={this.props.location.state.category}/>
                </div>
                <SideBar/>
            </div>
        );
